...
const findOutGender = (firstName)=>__awaiter(void 0, void 0, void 0, function*() {
        try {
            const gender = yield (0, _api.getGender)(firstName);
            if (result) {
                if (!gender.gender) {
                    result.textContent = (0, _error.ERROR).NAME_NOT_FOUND;
                    return;
                }
...
requestButton === null || requestButton === void 0 || requestButton.addEventListener("click", (event)=>{
    var _a;
    try {
        event === null || event === void 0 || event.preventDefault();
        const firstName = (_a = input === null || input === void 0 ? void 0 : input.value) !== null && _a !== void 0 ? _a : "";
        (0, _checks.checkEmptyRequest)(firstName);
        (0, _checks.checkValidRequest)(firstName);
...
},{"./error":"eQd1d","./checks":"aUOhJ","./api":"eqUwj"}],"eQd1d":[function(require,module,exports) {
...
},{}],"aUOhJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkValidRequest", ()=>checkValidRequest);
parcelHelpers.export(exports, "checkEmptyRequest", ()=>checkEmptyRequest);
var _error = require("./error");
const checkValidRequest = (firstName)=>{
    if (!/^[a-zA-Z]+$/.test(firstName)) throw new Error((0, _error.ERROR).INVALID_SEARCH_QUERY);
};
const checkEmptyRequest = (firstName)=>{
    if (!firstName) throw new Error((0, _error.ERROR).EMPTY_SEARCH_QUERY);
};

},{"./error":"eQd1d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eqUwj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getGender", ()=>getGender);
...
const getGender = (firstName)=>__awaiter(void 0, void 0, void 0, function*() {
        const url = `${SERVER_URL}?name=${firstName}`;
        const gender = (yield (0, _axiosDefault.default).get(url)).data;
        return gender;
    });

},{"./node_modules/axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequire063c")
