...
const socket = (0, _websocket.initWebsocket)();
const addMessage = (event)=>{
    event.preventDefault();
    event.stopPropagation();
    try {
        const message = ((0, _elements.inputMessage) === null || (0, _elements.inputMessage) === void 0 ? void 0 : (0, _elements.inputMessage).value) || "";
        (0, _checks.checkEmptyMessage)(message.trim());
        socket.send(JSON.stringify({
            text: message
        }));
        (0, _utils.clearInput)((0, _elements.inputMessage));
    } catch (error) {
...
socket.onmessage = (event)=>{
    ...
    if ((0, _store.blockedUsers).some((blockedUser)=>blockedUser.email === message.user.email)) return;
    (0, _store.changeTotalMessages)((0, _store.totalMessages) + 1);
    const newMessage = parseMessage(message, 1);
    (0, _store.addCurrentMessages)([
        newMessage
    ]);
    if (0, _elements.chatList) (0, _render.renderMessage)(newMessage, (0, _elements.chatList), "end");
};
const initCurrentUser = ()=>__awaiter(void 0, void 0, void 0, function*() {
        const userData = yield (0, _api.getUserInfo)();
        (0, _store.setCurrentUser)(userData);
    });
const initMessages = ()=>__awaiter(void 0, void 0, void 0, function*() {
        if (0, _elements.scrollTrigger) (0, _elements.scrollTrigger).style.display = "none";
        yield initCurrentUser();
        const data = yield (0, _api.getMessages)();
        const filtredData = data.filter((user)=>!(0, _store.blockedUsers).some((blockedUser)=>blockedUser.email === user.user.email));
        const chatHistory = filtredData.reverse().map((message, index)=>{
            return parseMessage(message, index);
        });
        (0, _store.addMessages)(chatHistory);
        (0, _store.changeTotalMessages)(chatHistory.length);
        const loadNewMessages = yield (0, _store.loadMessages)();
        if (0, _elements.chatList) (0, _render.renderMessages)(loadNewMessages.reverse(), (0, _elements.chatList), "start");
        if (0, _elements.scrollTrigger) (0, _elements.scrollTrigger).style.display = "block";
        if (0, _elements.loader) (0, _elements.loader).classList.add("hideElement");
    });
const parseMessage = (message, index)=>{
    const time = new Date(message.createdAt);
    return {
        sender: message.user,
        depatchTime: time.toLocaleTimeString().slice(0, 5),
        text: message.text
    };
};
if ((0, _elements.messageSendingForm) && (0, _elements.sendMessageButton)) (0, _elements.messageSendingForm).addEventListener("submit", addMessage);
if (0, _elements.loginLogoutButton) (0, _elements.loginLogoutButton).addEventListener("click", ()=>{
    (0, _utils.openModalWindow)((0, _elements.authorizationWindow));
});
if (0, _elements.enterCodeButton) (0, _elements.enterCodeButton).addEventListener("click", ()=>{
    (0, _utils.openModalWindow)((0, _elements.confirmationWindow));
});
if (0, _elements.settingsButton) (0, _elements.settingsButton).addEventListener("click", ()=>{
    (0, _utils.openModalWindow)((0, _elements.settingsWindow));
});
if (0, _elements.loginButton) (0, _elements.loginButton).addEventListener("click", ()=>{
    (0, _utils.closeModalWindow)((0, _elements.confirmationWindow));
    (0, _utils.closeModalWindow)((0, _elements.authorizationWindow));
});
if (0, _elements.closeSettings) (0, _elements.closeSettings).addEventListener("click", ()=>{
    (0, _utils.closeModalWindow)((0, _elements.settingsWindow));
});
if (0, _elements.closeAuthorization) (0, _elements.closeAuthorization).addEventListener("click", ()=>{
    (0, _utils.closeModalWindow)((0, _elements.authorizationWindow));
});
if (0, _elements.closeConfirmation) (0, _elements.closeConfirmation).addEventListener("click", ()=>{
    (0, _utils.closeModalWindow)((0, _elements.confirmationWindow));
    (0, _utils.closeModalWindow)((0, _elements.authorizationWindow));
});
if (0, _elements.getCodeButton) (0, _elements.getCodeButton).addEventListener("click", ()=>__awaiter(void 0, void 0, void 0, function*() {
        var _a;
        try {
            const email = (_a = (0, _elements.inputEmail) === null || (0, _elements.inputEmail) === void 0 ? void 0 : (0, _elements.inputEmail).value) !== null && _a !== void 0 ? _a : "";
            (0, _checks.checkEmptyEmail)(email);
            yield (0, _api.getToken)(email);
            (0, _utils.clearInput)((0, _elements.inputEmail));
        } catch (error) {
            console.log(error.message);
            alert((0, _errors.ERROR).EMPTY_EMAIL);
        }
    }));
if (0, _elements.loginButton) (0, _elements.loginButton).addEventListener("click", ()=>{
    var _a;
    try {
        const code = (_a = (0, _elements.inputCode) === null || (0, _elements.inputCode) === void 0 ? void 0 : (0, _elements.inputCode).value) !== null && _a !== void 0 ? _a : "";
        (0, _checks.checkEmptyCode)(code);
        (0, _cookie.setTokenToCookie)(code);
        (0, _utils.clearInput)((0, _elements.inputCode));
    } catch (error) {
        console.log(error.message);
        alert((0, _errors.ERROR).EMPTY_CODE);
    }
});
if (0, _elements.saveNameButton) (0, _elements.saveNameButton).addEventListener("click", (event)=>__awaiter(void 0, void 0, void 0, function*() {
        var _b;
        event.preventDefault();
        try {
            const userName = (_b = (0, _elements.inputName) === null || (0, _elements.inputName) === void 0 ? void 0 : (0, _elements.inputName).value) !== null && _b !== void 0 ? _b : "";
            (0, _checks.checkEmptyName)(userName);
            const newName = yield (0, _api.changeName)(userName);
            (0, _store.setCurrentUser)(Object.assign(Object.assign({}, (0, _store.currentUser)), {
                name: newName
            }));
            (0, _utils.closeModalWindow)((0, _elements.settingsWindow));
            (0, _utils.clearInput)((0, _elements.inputName));
        } catch (error) {
            console.log(error.message);
            alert((0, _errors.ERROR).EMPTY_NAME);
        }
    }));
if ((0, _elements.dialogWindow) && (0, _elements.scrollTrigger) && (0, _elements.loading)) {
    const showMessages = ()=>__awaiter(void 0, void 0, void 0, function*() {
            if ((0, _store.totalMessages) === (0, _store.currentMessages).length) {
                (0, _elements.loading).textContent = "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0439 \u0431\u043E\u043B\u044C\u0448\u0435 \u043D\u0435\u0442";
                (0, _elements.scrollTrigger).style.display = "none";
                (0, _elements.dialogWindow).removeEventListener("scroll", showMessages);
                return;
            }
            if ((0, _elements.dialogWindow).getBoundingClientRect().y < (0, _elements.scrollTrigger).getBoundingClientRect().y) {
                (0, _elements.scrollTrigger).style.display = "none";
                if ((0, _elements.loader) && (0, _elements.loaderContainer)) {
                    (0, _elements.loader).classList.remove("hideElement");
                    (0, _elements.loaderContainer).classList.add("loading");
                }
                const loadNewMessages = yield (0, _store.loadMessages)();
                if (0, _elements.chatList) (0, _render.renderMessages)(loadNewMessages.reverse(), (0, _elements.chatList), "start");
                (0, _elements.scrollTrigger).style.display = "block";
                if ((0, _elements.loader) && (0, _elements.loaderContainer)) {
                    (0, _elements.loader).classList.add("hideElement");
                    (0, _elements.loaderContainer).classList.remove("loading");
                }
            }
        });
    (0, _elements.dialogWindow).addEventListener("scroll", showMessages);
}
initMessages();

},{"./errors":"270rW","./elements":"aonE7","./checks":"aUOhJ","./api":"eqUwj","./cookie":"7KFrp","./store":"9cnTH","./utils":"bIDtH","./render":"jb02e","./websocket":"htIzP"}],"270rW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ERROR", ()=>ERROR);
const ERROR = {
    EMPTY_MESSAGE: "Message can not be empty",
    EMPTY_EMAIL: "Email not be entered",
    EMPTY_CODE: "Code not entered",
    EMPTY_NAME: "Chat name not entered",
    HISTORY_END: "You have already all messages"
};
...
},{}],"aonE7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "settingsWindow", ()=>settingsWindow);
parcelHelpers.export(exports, "authorizationWindow", ()=>authorizationWindow);
parcelHelpers.export(exports, "confirmationWindow", ()=>confirmationWindow);
parcelHelpers.export(exports, "inputMessage", ()=>inputMessage);
parcelHelpers.export(exports, "inputEmail", ()=>inputEmail);
parcelHelpers.export(exports, "inputName", ()=>inputName);
parcelHelpers.export(exports, "inputCode", ()=>inputCode);
parcelHelpers.export(exports, "loginLogoutButton", ()=>loginLogoutButton);
parcelHelpers.export(exports, "settingsButton", ()=>settingsButton);
parcelHelpers.export(exports, "saveNameButton", ()=>saveNameButton);
parcelHelpers.export(exports, "closeSettings", ()=>closeSettings);
parcelHelpers.export(exports, "getCodeButton", ()=>getCodeButton);
parcelHelpers.export(exports, "enterCodeButton", ()=>enterCodeButton);
parcelHelpers.export(exports, "closeAuthorization", ()=>closeAuthorization);
parcelHelpers.export(exports, "loginButton", ()=>loginButton);
parcelHelpers.export(exports, "closeConfirmation", ()=>closeConfirmation);
parcelHelpers.export(exports, "sendMessageButton", ()=>sendMessageButton);
parcelHelpers.export(exports, "chatList", ()=>chatList);
parcelHelpers.export(exports, "messageSendingForm", ()=>messageSendingForm);
parcelHelpers.export(exports, "loader", ()=>loader);
parcelHelpers.export(exports, "loaderContainer", ()=>loaderContainer);
parcelHelpers.export(exports, "loading", ()=>loading);
parcelHelpers.export(exports, "scrollTrigger", ()=>scrollTrigger);
parcelHelpers.export(exports, "dialogWindow", ()=>dialogWindow);
const settingsWindow = document.querySelector("#settings-popup");
const authorizationWindow = document.querySelector("#authorization-popup");
const confirmationWindow = document.querySelector("#confirmation-popup");
const inputMessage = document.querySelector("#add-message");
const inputEmail = document.querySelector("#input-email");
const inputName = document.querySelector("#input-name");
const inputCode = document.querySelector("#input-code");
const loginLogoutButton = document.querySelector("#exit");
const settingsButton = document.querySelector("#settings-button");
const saveNameButton = document.querySelector("#add-name");
const closeSettings = document.querySelector("#close-settings");
const getCodeButton = document.querySelector("#get-code");
const enterCodeButton = document.querySelector("#enter-code");
const closeAuthorization = document.querySelector("#close-authorization");
const loginButton = document.querySelector("#login");
const closeConfirmation = document.querySelector("#close-confirmation");
const sendMessageButton = document.querySelector("#send-message");
const chatList = document.querySelector("#chat-list");
const messageSendingForm = document.querySelector("#outgoing-message-text");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aUOhJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkEmptyCode", ()=>checkEmptyCode);
parcelHelpers.export(exports, "checkEmptyEmail", ()=>checkEmptyEmail);
parcelHelpers.export(exports, "checkEmptyMessage", ()=>checkEmptyMessage);
parcelHelpers.export(exports, "checkEmptyName", ()=>checkEmptyName);
var _errors = require("./errors");
const checkEmptyMessage = (message)=>{
    if (!message) {
        alert("Error" + (0, _errors.ERROR).EMPTY_MESSAGE);
        throw new Error((0, _errors.ERROR).EMPTY_MESSAGE);
    }
};
const checkEmptyEmail = (email)=>{
    if (!email) {
        alert("Error:" + (0, _errors.ERROR).EMPTY_EMAIL);
        throw new Error((0, _errors.ERROR).EMPTY_EMAIL);
    }
};
const checkEmptyCode = (code)=>{
    if (!code) {
        alert("Error"), (0, _errors.ERROR).EMPTY_CODE;
        throw new Error((0, _errors.ERROR).EMPTY_CODE);
    }
};
const checkEmptyName = (name)=>{
    if (!name) {
        alert("Error:" + (0, _errors.ERROR).EMPTY_NAME);
        throw new Error((0, _errors.ERROR).EMPTY_NAME);
    }
};

},{"./errors":"270rW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eqUwj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
// export const BASE_URL = 'https://edu.strada.one/api/';
const http = (0, _axiosDefault.default).create({
    baseURL: (0, _constants.BASE_URL)
});
const getToken = (email)=>__awaiter(void 0, void 0, void 0, function*() {
        http.post("user", {
            email: email
        });
    });
const getMessages = ()=>__awaiter(void 0, void 0, void 0, function*() {
        const response = yield http.get("messages");
        return response.data.messages;
    });
const changeName = (userName)=>__awaiter(void 0, void 0, void 0, function*() {
        const response = yield http.patch("user", {
            name: userName
        });
        return response.data.name;
    });
http.interceptors.request.use((config)=>{
    const tokenFromCookie = (0, _cookie.getTokenFromCookie)();
    if (tokenFromCookie) config.headers.Authorization = `Bearer ${tokenFromCookie}`;
    return config;
});
const getUserInfo = ()=>__awaiter(void 0, void 0, void 0, function*() {
        const response = yield http.get("user/me");
        return response.data;
    });

},{"./cookie":"7KFrp","./constants":"8eIVP","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7KFrp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setTokenToCookie", ()=>setTokenToCookie);
parcelHelpers.export(exports, "getTokenFromCookie", ()=>getTokenFromCookie);
const setTokenToCookie = (tokenValue)=>{
    document.cookie = `token=${tokenValue}`;
};
const getTokenFromCookie = ()=>{
    const cookiesArray = document.cookie.split(";").map((cookie)=>cookie.trim());
    const tokenFromCookie = cookiesArray.find((item)=>{
        const [key, value] = item.split("=");
        if (key === "token") return true;
        return false;
    });
    if (tokenFromCookie) {
        const [key, tokenValue] = tokenFromCookie.split("=");
        return tokenValue;
    }
    return "";
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8eIVP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PER_PAGE", ()=>PER_PAGE);
parcelHelpers.export(exports, "BASE_URL", ()=>BASE_URL);
parcelHelpers.export(exports, "THEME_LS_KEY", ()=>THEME_LS_KEY);
const PER_PAGE = 20;
const BASE_URL = "https://edu.strada.one/api/";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9cnTH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "addMessages", ()=>addMessages);
parcelHelpers.export(exports, "currentMessages", ()=>currentMessages);
parcelHelpers.export(exports, "addCurrentMessages", ()=>addCurrentMessages);
parcelHelpers.export(exports, "totalMessages", ()=>totalMessages);
parcelHelpers.export(exports, "changeTotalMessages", ()=>changeTotalMessages);
parcelHelpers.export(exports, "loadMessages", ()=>loadMessages);
parcelHelpers.export(exports, "blockedUsers", ()=>blockedUsers);
parcelHelpers.export(exports, "addToBlock", ()=>addToBlock);
parcelHelpers.export(exports, "removeFromBlock", ()=>removeFromBlock);
var _constants = require("./constants");
var _render = require("./render");
var __awaiter = undefined && undefined.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
...
const blockedUsersList = document.querySelector("#blocked-users");
let currentUser = {
    email: "",
    name: ""
};
...
let page = 0;
let currentMessages = [];
const addCurrentMessages = (newMessages)=>{
    currentMessages.push(...newMessages);
};
let totalMessages = 0;
const changeTotalMessages = (count)=>{
    totalMessages = count;
};
const loadMessages = ()=>__awaiter(void 0, void 0, void 0, function*() {
        const promise = new Promise((resolve)=>{
            page = page + 1;
            let startIndex = messages.length - page * (0, _constants.PER_PAGE);
            const endIndex = messages.length - (page - 1) * (0, _constants.PER_PAGE);
            if (startIndex < 0) startIndex = 0;
            const pageMessages = messages.slice(startIndex, endIndex);
            setTimeout(()=>{
                currentMessages.unshift(...pageMessages);
...
const addToBlock = (user)=>{
    if (!blockedUsers.some((blockedUser)=>blockedUser.email === user.email)) {
        blockedUsers.push(user);
        const blockedMessages = currentMessages.filter((message)=>message.sender.email === user.email);
        const blockedMessagesCount = blockedMessages.length;
        if (blockedMessagesCount) {
            const updatedMessages = messages.filter((message)=>!blockedUsers.some((blockedUser)=>blockedUser.email === message.sender.email));
            messages = updatedMessages;
            const updatedCurrentMessages = currentMessages.filter((message)=>!blockedUsers.some((blockedUser)=>blockedUser.email === message.sender.email));
            let startIndex = messages.length - page * (0, _constants.PER_PAGE);
            let endIndex = messages.length - page * (0, _constants.PER_PAGE) + blockedMessagesCount;
            if (startIndex < 0) startIndex = 0;
            if (endIndex > messages.length - 1) endIndex = messages.length - 1;
            updatedCurrentMessages.unshift(...messages.slice(startIndex, endIndex));
            currentMessages = updatedCurrentMessages;
            changeTotalMessages(messages.length);
        }
        if (blockedUsersList) (0, _render.renderNewBlockedUser)(user, blockedUsersList);
        return currentMessages;
    }
};
const removeFromBlock = (userEmail)=>{
    const updatedBlockedUsers = blockedUsers.filter((user)=>user.email !== userEmail);
    blockedUsers = updatedBlockedUsers;
};

},{"./constants":"8eIVP","./render":"jb02e","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jb02e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMessage", ()=>renderMessage);
parcelHelpers.export(exports, "renderMessages", ()=>renderMessages);
parcelHelpers.export(exports, "renderNewBlockedUser", ()=>renderNewBlockedUser);
var _store = require("./store");
const renderMessage = (message, chatList, position)=>{
    const li = document.createElement("li");
    const senderSpan = document.createElement("span");
    const textSpan = document.createElement("span");
    const depatchTimeSpan = document.createElement("span");
    const depatchTimeText = document.createElement("span");
    li.classList.add("message-row", "delivered");
    if (message.sender.email === (0, _store.currentUser).email) {
        li.classList.add("my");
        depatchTimeText.classList.add("my-message");
    } else {
        const blockUserButton = document.createElement("button");
        blockUserButton.addEventListener("click", ()=>{
            const updatedMessages = (0, _store.addToBlock)(message.sender);
            if (updatedMessages) renderMessages(updatedMessages, chatList, "end", true);
        });
        blockUserButton.title = "\u0417\u0430\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F";
        blockUserButton.innerHTML = `<svg width="10" height="10" viewBox="0 0 17 16" fill="none"
        ...
        depatchTimeSpan.appendChild(blockUserButton);
    }
    senderSpan.classList.add("sender");
    textSpan.classList.add("message-text");
    depatchTimeSpan.classList.add("depatch-time");
    senderSpan.textContent = `${message.sender.name}:`;
    textSpan.textContent = message.text;
    depatchTimeText.textContent = message.depatchTime;
    depatchTimeSpan.appendChild(depatchTimeText);
    li.appendChild(senderSpan);
    li.appendChild(textSpan);
    li.appendChild(depatchTimeSpan);
    if (position === "start") chatList.prepend(li);
    else chatList.appendChild(li);
};
const renderMessages = (messages, chatList, position, clearBefore)=>{
    if (clearBefore) chatList.replaceChildren();
    messages.forEach((message)=>{
        renderMessage(message, chatList, position);
    });
};
const renderNewBlockedUser = (user, blockedUsersList)=>{
    const li = document.createElement("li");
    const button = document.createElement("button");
    const span = document.createElement("span");
    span.textContent = user.name;
    button.classList.add("close-icon");
    button.innerHTML = `<svg width="15" height="15" viewBox="0 0 17 16" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <line y1="-0.5" x2="20.7803" y2="-0.5"
        transform="matrix(0.710506 0.703691 -0.65218 0.758064 1 1)" stroke="#998899" />
        <line y1="-0.5" x2="20.8155" y2="-0.5"
    ...
    button.title = "\u0424\u0443\u043D\u043A\u0446\u0438\u044F \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u044F \u0432 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0435";
...
},{"./store":"9cnTH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bIDtH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCurrentTime", ()=>getCurrentTime);
parcelHelpers.export(exports, "openModalWindow", ()=>openModalWindow);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"htIzP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWebsocket", ()=>initWebsocket);
var _cookie = require("./cookie");
const token = (0, _cookie.getTokenFromCookie)();
const initWebsocket = ()=>{
    const socket = new WebSocket(`wss://edu.strada.one/websockets?${token}`);
    return socket;
};

},{"./cookie":"7KFrp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequire25d8")
